...
def seed_official_exam_2025_0102():
    with app.app_context():
        # 1. Xóa triệt để dữ liệu cũ của mã 0102 nếu có
        Question.query.filter_by(year=2025, code_id='0102').delete()
        db.session.commit()

        # 2. Danh sách 22 câu hỏi chuẩn nguyên văn Mã đề 0102 + Đáp án Bộ GD&ĐT
        questions_data = [
            # ================= PHẦN I (12 CÂU TRẮC NGHIỆM ĐƠN) =================
            {
                "question_number": 1,
                "question_type": "PART_I",
                "content": "Trong mặt phẳng với hệ tọa độ $Oxy$, diện tích $S$ của hình phẳng giới hạn bởi đồ thị hàm số $y = 2x + 1$, trục hoành và hai đường thẳng $x = 1, x = 2$ được xác định bằng công thức",
                "image_url": None,
                "option_a": "$S = \\pi \\int_{1}^{2} (2x + 1) dx$.",
                "option_b": "$S = \\int_{1}^{2} (2x + 1)^2 dx$.",
                "option_c": "$S = \\pi \\int_{1}^{2} (2x + 1)^2 dx$.",
                "option_d": "$S = \\int_{1}^{2} (2x + 1) dx$.",
                "correct_ans": "D",
            ...
            },
            {
                "question_number": 2,
                "question_type": "PART_I",
                "content": "Trong không gian với hệ tọa độ $Oxyz$, mặt phẳng đi qua gốc tọa độ và nhận $\\vec{n} = (-1; 0; 3)$ làm một vectơ pháp tuyến có phương trình tổng quát là",
                "image_url": None,
                "option_a": "$-x + 3y = 0$.",
                "option_b": "$-y + 3z = 0$.",
                "option_c": "$-x + 3z = 0$.",
            ...
            },
            {
                "question_number": 4,
                "question_type": "PART_I",
                "content": "Họ nguyên hàm của hàm số $f(x) = \\sin x + \\cos x$ là",
                "image_url": None,
                "option_a": "$\\cos x + \\sin x + C$.",
                "option_b": "$\\cos x - \\sin x + C$.",
                "option_c": "$-\\cos x - \\sin x + C$.",
                "option_d": "$-\\cos x + \\sin x + C$.",
                "correct_ans": "D",
                "bloom_level": "Nhận biết"
            },
            {
                "question_number": 5,
                "question_type": "PART_I",
                "content": "Cho hàm số $y = \\frac{ax + b}{cx + d}$ ($ac \\neq 0, ad - bc \\neq 0$) có bảng biến thiên như hình bên dưới.<br><table class='table table-bordered text-center my-2' style='max-width: 500px; margin: 0 auto;'><tr><td>$x$</td><td>$-\\infty$</td><td></td><td>$-2$</td><td></td><td>$+\\infty$</td></tr><tr><td>$y'$</td><td></td><td>$-$</td><td>||</td><td>$-$</td><td></td></tr><tr><td>$y$</td><td>1 $\\searrow$</td><td>$-\\infty$</td><td>||</td><td>$+\\infty$ $\\searrow$</td><td>1</td></tr></table>Đường tiệm cận đứng của đồ thị hàm số đã cho có phương trình là",
                "image_url": None,
                "option_a": "$y = -2$.",
                "option_b": "$x = -2$.",
                "option_c": "$y = 1$.",
            ...
            },
            {
                "question_number": 6,
                "question_type": "PART_I",
                "content": "Cho cấp số cộng $(u_n)$ với $u_1 = 2$ và công sai $d = 3$. Giá trị của $u_5$ bằng",
                "image_url": None,
                "option_a": "14.",
                "option_b": "15.",
                "option_c": "17.",
            ...
            },
            {
                "question_number": 7,
                "question_type": "PART_I",
                "content": "Trong không gian với hệ tọa độ $Oxyz$, cho mặt phẳng $(P): 2x - 4y + 3z - 9 = 0$. Vectơ nào sau đây là một vectơ pháp tuyến của mặt phẳng $(P)$?",
                "image_url": None,
                "option_a": "$\\vec{n}_3 = (-2; 4; 3)$.",
                "option_b": "$\\vec{n}_1 = (2; 4; 3)$.",
                "option_c": "$\\vec{n}_4 = (2; -4; 3)$.",
                "option_d": "$\\vec{n}_2 = (2; 4; -3)$.",
                "correct_ans": "C",
                "bloom_level": "Nhận biết"
            },
            {
                "question_number": 8,
                "question_type": "PART_I",
                "content": "Một người chia thời lượng (đơn vị: giây) thực hiện các cuộc gọi điện thoại của mình trong một tuần thành sáu nhóm và lập bảng tần số ghép nhóm như sau:<br><table class='table table-bordered text-center my-2' style='max-width: 600px; margin: 0 auto;'><tr><td>Nhóm</td><td>[0;30)</td><td>[30;60)</td><td>[60;90)</td><td>[90;120)</td><td>[120;150)</td><td>[150;180)</td></tr><tr><td>Tần số</td><td>10</td><td>11</td><td>8</td><td>6</td><td>4</td><td>1</td></tr></table>Tứ phân vị thứ ba $Q_3$ (đơn vị: giây) của mẫu số liệu ghép nhóm trên bằng",
                "image_url": None,
                "option_a": "100.",
                "option_b": "95.",
                "option_c": "105.",
            ...
            },
            {
                "question_number": 9,
                "question_type": "PART_I",
                "content": "Tập nghiệm của phương trình $\\sin x = 1$ là",
                "image_url": None,
                "option_a": "$S = \\left\\{\\frac{\\pi}{2} + k2\\pi \\mid k \\in \\mathbb{Z}\\right\\}$.",
                "option_b": "$S = \\left\\{\\frac{\\pi}{2} + k\\pi \\mid k \\in \\mathbb{Z}\\right\\}$.",
                "option_c": "$S = \\{k2\\pi \\mid k \\in \\mathbb{Z}\\}$.",
            ...
            },
            {
                "question_number": 10,
                "question_type": "PART_I",
                "content": "Cho khối chóp $O.ABC$ có $OA$ vuông góc với mặt phẳng $(ABC)$, tam giác $ABC$ vuông tại $A$ và $OA = 2, AB = 3, AC = 6$. Thể tích của khối chóp $O.ABC$ bằng",
                "image_url": None,
                "option_a": "12.",
                "option_b": "18.",
                "option_c": "6.",
            ...
            },
            {
                "question_number": 11,
                "question_type": "PART_I",
                "content": "Cho hình lăng trụ $ABC.A'B'C'$ (xem hình dưới). Đường thẳng $B'C'$ song song với mặt phẳng nào sau đây?",
            ...
            },
            {
                "question_number": 12,
                "question_type": "PART_I",
                "content": "Cho hình chóp tứ giác đều $S.ABCD$ (xem hình dưới). Gọi $O$ là giao điểm của $AC$ và $BD$. Phát biểu nào sau đây là đúng?",
                "image_url": "images/q12_pyramid.png",
                "option_a": "$\\overrightarrow{SA} + \\overrightarrow{SB} + \\overrightarrow{SC} + \\overrightarrow{SD} = 4\\overrightarrow{SO}$.",
                "option_b": "$\\overrightarrow{SA} + \\overrightarrow{SB} + \\overrightarrow{SC} + \\overrightarrow{SD} = 2\\overrightarrow{SO}$.",
                "option_c": "$\\overrightarrow{SA} + \\overrightarrow{SB} + \\overrightarrow{SC} + \\overrightarrow{SD} = \\vec{0}$.",
                "option_d": "$\\overrightarrow{SA} + \\overrightarrow{SB} + \\overrightarrow{SC} + \\overrightarrow{SD} = \\overrightarrow{SO}$.",
                "correct_ans": "A",
                "bloom_level": "Nhận biết"
            },
            ...
            # ================= PHẦN II (4 CÂU ĐÚNG / SAI) =================
            {
                ...
                "content": "Cho hàm số $f(x) = x^3 - 27x + 81$.",
                "image_url": None,
                "sub_q_a": "Hàm số đã cho có đạo hàm là $f'(x) = 3x^2 - 27$.",
                "sub_q_b": "Phương trình $f'(x) = 0$ có tập nghiệm là $S = \\{3\\}$.",
                "sub_q_c": "$f(3) = 27$.",
                "sub_q_d": "Giá trị nhỏ nhất của hàm số $f(x)$ trên đoạn $[-4; 4]$ bằng 27.",
            ...
            },
            {
                ...
                "image_url": None,
                "sub_q_a": "Xác suất để tin nhắn đó không bị đánh dấu bằng 0,8.",
                "sub_q_b": "Xác suất để tin nhắn đó không phải là quảng cáo, biết rằng nó không bị đánh dấu, bằng 0,95.",
                "sub_q_c": "Xác suất để tin nhắn đó không phải là quảng cáo bằng 0,76.",
                "sub_q_d": "Xác suất để tin nhắn đó không bị đánh dấu, biết rằng nó không phải là quảng cáo, nhỏ hơn 0,95.",
            ...
            },
            {
                ...
                "image_url": None,
                "sub_q_a": "$g(t) = kt + C$ ($t \\ge 0$) với $C$ là một hằng số xác định.",
                "sub_q_b": "$k = -\\frac{\\ln 2}{6}$.",
                "sub_q_c": "$C = 3\\ln 2$.",
                "sub_q_d": "Nồng độ thuốc tồn dư trong nước tại thời điểm $t = 20$ (ngày) kể từ lúc sử dụng thuốc lớn hơn 0,4 mg/lít.",
            ...
            },
            {
                "question_number": 21,
                "question_type": "PART_III",
                "content": "Có bốn ngăn (trong một giá để sách) được đánh số thứ tự 1, 2, 3, 4 và tám quyển sách khác nhau. Bạn An xếp hết tám quyển sách nói trên vào bốn ngăn đó sao cho mỗi ngăn có ít nhất một quyển sách và các quyển sách được xếp thẳng đứng thành một hàng ngang với gáy sách quay ra ngoài ở mỗi ngăn. Khi đã xếp xong tám quyển sách, hai cách xếp của bạn An được gọi là giống nhau nếu chúng thỏa mãn đồng thời hai điều kiện sau đây:<br>+ Với từng ngăn, số lượng quyển sách ở ngăn đó là như nhau trong cả hai cách xếp;<br>+ Với từng ngăn, thứ tự từ trái sang phải của các quyển sách được xếp là như nhau trong cả hai cách xếp.<br>Gọi $T$ là số cách xếp đôi một khác nhau của bạn An. Giá trị của $\\frac{T}{600}$ bằng bao nhiêu?",
                "image_url": None,
                "correct_ans": "2150",
                "bloom_level": "Vận dụng cao"
            },
            {
                "question_number": 22,
                "question_type": "PART_III",
                "content": "Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình vuông với $AB = 2$. Biết rằng hình chiếu vuông góc của $S$ trên mặt phẳng $(ABCD)$ là trọng tâm $H$ của tam giác $ABC$ và $SH = \\sqrt{2}$. Khoảng cách giữa hai đường thẳng $AC$ và $SD$ bằng bao nhiêu (không làm tròn kết quả các phép tính trung gian, chỉ làm tròn kết quả cuối cùng đến hàng phần trăm)?",
                "image_url": None,
                "correct_ans": "0.85",
                "bloom_level": "Vận dụng cao"
            }
        ...
        db.session.commit()
        print("🎉 Đã thêm MÃ ĐỀ 0102 chuẩn Bộ GD&ĐT 2025 vào CSDL!")

if __name__ == "__main__":
    seed_official_exam_2025_0102()